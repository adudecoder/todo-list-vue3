...
mr-2">
                    <button @click="onCheckClick"
                        :class="{'text-green-700': isCompleted, 'text-gray-400': !isCompleted,}">
                ...
                <div class="w-full">
                    <input v-model="title" @keyup.enter="onTitleChange" type="text" placeholder="Digite a sua tarefa"
